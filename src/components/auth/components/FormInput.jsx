                ...
                <AnimatePresence>
                    {error && showTooltip && (
                        <motion.div
                            ...
                            className="absolute left-0 -top-12 w-full z-50"
                        >
                            <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 text-sm rounded-lg px-3 py-2 shadow-lg">
