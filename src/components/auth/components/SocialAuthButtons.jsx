...
export function SocialAuthButtons({ onGoogleClick, onGithubClick, disabled }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-lg mx-auto px-4">
